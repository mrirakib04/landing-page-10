import mountainImg from "./../assets/img/Rectangle 4.png";
  ...
  return (
    <div className="container flex md:flex-row flex-col items-center w-full gap-5 md:py-20 py-10 px-5">
      <div className="flex flex-col items-start gap-1 md:w-1/2 w-full">
        ...
        <ul className="px-4 list-disc mt-5 text-gray-700">
          <li>
          ...
          <li>
            ...
            Architecto, corrupti dolore! Distinctio!
          </li>
          <li>
            Tempus euismod lacus mauris dignissim quis in ultrices. Magna nullam
            odio neque diam.
        ...
        <div>
          <button className="mt-5 py-2 px-4 w-full bg-orange-600 hover:bg-black duration-300 rounded-md text-white flex items-center gap-1 text-center justify-center font-semibold">
            Read More
          </button>
        </div>
      </div>
